    ...
    const htmlContent = `
      <html>
        ...
        <body>
          <div class="header">
            <div>
              <h1 class="brand-name">Jemmyland Hotels</h1>
          ...
          <div class="footer">
            <p>This is an official document generated by the Jemmyland Hotels PMS.</p>
            <p>© 2026 Jemmyland Hotels. All rights reserved.</p>
          </div>
