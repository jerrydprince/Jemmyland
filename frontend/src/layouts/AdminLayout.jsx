      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 glass-panel flex flex-col transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <nav className="flex-1 px-4 py-8 space-y-6 overflow-y-auto custom-scrollbar select-none">
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-0.5 animate-in slide-in-from-top-1 fade-in duration-200 mt-1">
              {hasAnyAccess('Dashboard') && (
                <Link to="/admin" onClick={closeMobileMenu} className={linkClass('/admin')}>
                  <div className="flex items-center gap-2.5 relative z-10">
              ...
              {hasAnyAccess('Internal Messaging') && (
                <Link to="/admin/messages" onClick={closeMobileMenu} className={linkClass('/admin/messages')}>
                  <div className="flex items-center gap-2.5 relative z-10">
              ...
              {hasAnyAccess('Reminders') && (
                <Link to="/admin/reminders" onClick={closeMobileMenu} className={linkClass('/admin/reminders')}>
                  <div className="flex items-center gap-2.5 relative z-10">
              ...
              {hasAnyAccess('Reports & Analytics') && (
                <Link to="/admin/reports" onClick={closeMobileMenu} className={linkClass('/admin/reports')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <TrendingUp size={16} />
              ...
              {hasAnyAccess('Duty Logs') && (
                <Link to="/admin/duty-reports" onClick={closeMobileMenu} className={linkClass('/admin/duty-reports')}>
                  <div className="flex items-center gap-2.5 relative z-10">
              ...
              {hasAnyAccess('Monthly Reports') && (
                <Link to="/admin/monthly-reports" onClick={closeMobileMenu} className={linkClass('/admin/monthly-reports')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <MailOpen size={16} />
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-0.5 animate-in slide-in-from-top-1 fade-in duration-200 mt-1">
              {hasAnyAccess('Front Desk') && (
                <Link to="/admin/frontdesk" onClick={closeMobileMenu} className={linkClass('/admin/frontdesk')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Bell size={16} />
              ...
              {hasAnyAccess('Reservations') && (
                <Link to="/admin/reservations" onClick={closeMobileMenu} className={linkClass('/admin/reservations')}>
                  <div className="flex items-center gap-2.5 relative z-10">
              ...
              {hasAnyAccess('CRM & Guests') && (
                <Link to="/admin/crm" onClick={closeMobileMenu} className={linkClass('/admin/crm')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Users size={16} />
              ...
              {hasAnyAccess('Lost & Found') && (
                <Link to="/admin/lost-found" onClick={closeMobileMenu} className={linkClass('/admin/lost-found')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <SearchCheck size={16} />
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-0.5 animate-in slide-in-from-top-1 fade-in duration-200 mt-1">
              {hasAnyAccess('Housekeeping') && (
                <Link to="/admin/housekeeping" onClick={closeMobileMenu} className={linkClass('/admin/housekeeping')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Sparkles size={16} />
              ...
              {hasAnyAccess('Laundry') && (
                <Link to="/admin/laundry" onClick={closeMobileMenu} className={linkClass('/admin/laundry')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Shirt size={16} />
              ...
              {hasAnyAccess('Maintenance') && (
                <Link to="/admin/maintenance" onClick={closeMobileMenu} className={linkClass('/admin/maintenance')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Wrench size={16} />
              ...
              {(hasAnyAccess('Store Keeping') || user?.role === 'super_admin') && (
                <Link to="/admin/store" onClick={closeMobileMenu} className={linkClass('/admin/store')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Archive size={16} />
              ...
              {(hasAnyAccess('Restaurant Desk') || hasAnyAccess('Kitchen Desk') || hasAnyAccess('Order History') || user?.role === 'super_admin') && (
                <Link to="/admin/restaurant" onClick={closeMobileMenu} className={linkClass('/admin/restaurant')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <ChefHat size={16} />
              ...
              {(hasAnyAccess('Service Portals') || user?.role === 'super_admin') && (
                <Link to="/admin/services-portal" onClick={closeMobileMenu} className={linkClass('/admin/services-portal')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Compass size={16} />
          ...
          <div className="space-y-1">
            ...
            {openMenus.pos && (
            <div className="space-y-0.5 animate-in slide-in-from-top-1 fade-in duration-200 mt-1">
              <Link to="/admin/pos" onClick={closeMobileMenu} className={linkClass('/admin/pos')}>
                <div className="flex items-center gap-2.5 relative z-10">
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-0.5 animate-in slide-in-from-top-1 fade-in duration-200 mt-1">
              {hasAnyAccess('Finance & Billing') && (
                <Link to="/admin/billing" onClick={closeMobileMenu} className={linkClass('/admin/billing')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <FileText size={16} />
              ...
              {hasAnyAccess('Accounting') && (
                <Link to="/admin/accounting" onClick={closeMobileMenu} className={linkClass('/admin/accounting')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Wallet size={16} />
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-0.5 animate-in slide-in-from-top-1 fade-in duration-200 mt-1">
              {(hasAnyAccess('Rooms') || user?.role === 'super_admin') && (
                <Link to="/admin/rooms" onClick={closeMobileMenu} className={linkClass('/admin/rooms')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <BedDouble size={16} />
              ...
              {hasAnyAccess('Channel Manager') && (
                <Link to="/admin/channel-manager" onClick={closeMobileMenu} className={linkClass('/admin/channel-manager')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Network size={16} />
              ...
              {(hasAnyAccess('Staff & Roles') || hasAccess('Leave & Absences - Request Leave of Absence') || hasAccess('Leave & Absences - Review Leave Applications')) && (
                <Link to="/admin/staff" onClick={closeMobileMenu} className={linkClass('/admin/staff')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <ShieldCheck size={16} />
              ...
              {hasAnyAccess('Website CMS') && (
                <Link to="/admin/cms" onClick={closeMobileMenu} className={linkClass('/admin/cms')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Globe size={16} />
              ...
              {hasAnyAccess('Settings') && (
                <Link to="/admin/settings" onClick={closeMobileMenu} className={linkClass('/admin/settings')}>
                  <div className="flex items-center gap-2.5 relative z-10">
                    <Settings size={16} />
